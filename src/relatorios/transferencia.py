...
from src.utils.utilitarios.extrairdados import obter_dados_aluno, obter_dados_responsaveis
...
from src.utils.utilitarios.tipos_documentos import TIPO_TRANSFERENCIA
