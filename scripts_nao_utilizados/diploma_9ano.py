...
WHERE 
    al.id = 1  -- Filtrando pelo ano letivo específico
AND 
    a.escola_id = 60
AND 
    s.nome = '9º Ano'
...
if not dados_alunos:
    ...
    def criar_diploma(aluno, caminho, pdf_base):
        ...
        can.drawString(x_pos9, y_pos5, 'EM Profª Nadir Nascimento Moraes' if aluno['nome_escola'] else "Escola não informado")
