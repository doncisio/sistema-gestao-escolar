...
-- Script de criação das tabelas (v2 - Compatível com tipos INT existentes)
-- Data: 29/11/2025
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS questoes (
    ...
    escola_id INT DEFAULT NULL COMMENT 'NULL = todas as escolas da rede',
    
    autor_id INT NOT NULL COMMENT 'Funcionário que criou a questão',
...
CREATE TABLE IF NOT EXISTS respostas_alunos (
    ...
    corrigida_por INT DEFAULT NULL,
