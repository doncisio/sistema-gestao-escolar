"""
Excluir duplicados dos 3 alunos que já tinham matrícula
IDs a excluir: 2888, 2889, 2890
"""
from db.connection import conectar_bd

# IDs dos duplicados (sem matrícula)
duplicados = [
    {'id': 2888, 'nome': 'John Miguel Moreira Monteiro', 'cpf': '10829976337'},
    {'id': 2889, 'nome': 'Mauricio Silva Miranda', 'cpf': '63763355359'},
    {'id': 2890, 'nome': 'Murilo Silva Miranda', 'cpf': '63763357300'}
]
