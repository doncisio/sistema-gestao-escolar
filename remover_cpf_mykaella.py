"""
Script para remover CPF incorreto de Mykaella Rafisa Silva Ramos
ID: 40
CPF incorreto: 63545291324 (pertence a outra pessoa)
"""
...
def remover_cpf_incorreto():
    ...
    id_aluno = 40
    cpf_incorreto = '63545291324'
    
    print("="*80)
    print("REMOVENDO CPF INCORRETO DE MYKAELLA RAFISA SILVA RAMOS")
    print("="*80)
...
if __name__ == "__main__":
    print("\nATENCAO: Este script vai remover o CPF incorreto do aluno ID 40")
