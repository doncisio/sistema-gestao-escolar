"""
Excluir duplicados do 9º ano
IDs a excluir: 2058, 2923
"""
from db.connection import conectar_bd

# IDs dos duplicados (sem matrícula)
duplicados = [
    {'id': 2058, 'nome': 'Ana Clara Silva de Albuquerque'},
    {'id': 2923, 'nome': 'Maysa Estefany Belem Ferreira'}
]

print("="*80)
print("EXCLUSÃO DE DUPLICADOS DO 9º ANO")
print("="*80)
